...
| 項目 | 状態 | メモ |
|------|------|------|
| UX 改善 | 任意 | 結果の由来表示、初期デッキ6枚化など。プリセットは当面スコープ外。※レギュ絞込適用ボタン v0.1.7・説明書 v0.1.5・発動条件タグ絞込 v0.1.6・スキル名コピー v0.1.8・トレヒントLv v0.1.9・継承スキル数 v0.1.10・優先38種 v0.1.11 で実装済み |
