...
**独立ビジュアルモックで方向決め** — 現行 app は触らず提案を見てから移植。push / Pages は v1.0.0 までしない。
...
- [~] **ビジュアル方向モック**（独立 HTML）— [`product/mockups/redesign-proposal-v3.html`](./product/mockups/redesign-proposal-v3.html)（緑メイン）／[v2](./product/mockups/redesign-proposal-v2.html) 比較のフィードバック待ち → 方向確定後に app へ移植
