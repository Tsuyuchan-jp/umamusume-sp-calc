...
**UX Phase D 残り** — 質感パス実装済（二マグネット・バー正本・列下イベント）。push / Pages は v1.0.0 までしない。
...
- [x] 2026-08-02 **全体デザインの質感パス**（二マグネット・ギャラリー・列下イベント・バー正本 B2/D3・ピッカー絞込・scroll-snap）
...
- [x] 2026-08-02 全体デザインの質感パス（二マグネット・ギャラリー・列下イベント・バー正本・ピッカー絞込・scroll-snap）
