...
- [~] **ビジュアル方向モック** — [v4](./product/mockups/redesign-proposal-v4.html)（別UX）/ [v3](./product/mockups/redesign-proposal-v3.html) / [v2](./product/mockups/redesign-proposal-v2.html) のフィードバック待ち → 方向確定後に app へ移植
