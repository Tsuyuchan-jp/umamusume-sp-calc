...
**P2 編成スクショ** — v17 金縦並び＋レギュ／除外目視（[screenshot-share-hero.html](./product/mockups/screenshot-share-hero.html)）
...
- [~] **編成スクショ機能**（要件すり合わせ中・2026-08-02）  
  ...
  - 次: **v17 目視**（金縦並び・レギュ／手動除外）→ [mockups/screenshot-share-hero.html](./product/mockups/screenshot-share-hero.html)（採用 / 方向違い / 惜しい＋一言）  
