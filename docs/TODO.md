...
**P2 スマホ対応** — 受け入れ条件合意済。実装着手可（[UX.md](./product/UX.md#v1-受け入れ条件合意2026-08-03)）
...
- [~] **スマホ対応**（合意済・実装待ち） — ≤1199 ギャラリー固定・modebar 非表示・共有は合計バー・自動削除・タップ／表／余白は v1 目標（[UX.md](./product/UX.md#v1-受け入れ条件合意2026-08-03)）
