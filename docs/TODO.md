...
**P2 待ち** — 編成スクショ／回帰テスト拡充など（UX 磨きパック完了）
...
- [x] 2026-08-02 **列下自動イベント表示** — 金自動最上段・複数金名。**実機OKでクローズ**
- [x] 2026-08-02 **列下金スキル表記統一** — 金は skills から「スキル名 Lv○」を1行ずつ（選択式・自動共通）
- [x] 2026-08-02 **メモリ一覧サムネ案B** — 育成＋サポ2×3。**実機OKでクローズ**（サムネ拡大・育成中央揃え調整済み）
