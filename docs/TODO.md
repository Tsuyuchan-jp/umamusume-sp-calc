...
**デザイン仕上げの必須残はほぼ無し** — 人間が「まだ気になる点」を出さなければ見た目パスはクローズ可（[product/design-polish-backlog.md](./product/design-polish-backlog.md)）。
...
（なし — 見た目の必須残は再判定で下ろした。気になる点があればここに追加）
...
- [ ] **パネル質感（bg.webp／幾何）** — H5 パリティ。需要があれば
- [ ] **ヘッダー幅の中央寄せ** — 見た目のみ・任意
...
- [x] 2026-08-02 **デザイン残件の再判定** — 初版 P0/P1 は移植前の残骸寄り。必須仕上げは無しと訂正（[product/design-polish-backlog.md](./product/design-polish-backlog.md)）
- [x] 2026-08-02 **細かいデザイン残件の一括メモ** — 初版作成 → 同日再判定で修正
