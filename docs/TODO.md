...
- [x] 2026-08-02 **ヘッダーをモック構造へ修正** — 浮いた別帯をやめ、編成パネル先頭の g-brand に。背景は `auto 100%` で空＋芝
- [x] 2026-08-02 **背景を U-tools/H5 引き構図へ**・幾何タイル・スプリット左ゾーン
- [x] 2026-08-02 **ヘッダー比較モック**・実機指摘 backlog 化
