...
- [~] **ビジュアル方向モック** — [v5](./product/mockups/redesign-proposal-v5.html)（v2×v4）/ [v4](./product/mockups/redesign-proposal-v4.html) / [v2](./product/mockups/redesign-proposal-v2.html) のフィードバック待ち → 方向確定後に app へ移植
