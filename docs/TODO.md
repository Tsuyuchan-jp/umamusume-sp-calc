...
**P2 スマホ対応** — フェーズ1対話中（DevTools 390×844 所感共有・受け入れ条件の合意待ち）
...
- [~] **スマホ対応**（対話中・実装前） — DevTools 390×844 で現状確認済み。**v1 前スコープは人間合意後に UX.md / 本行へ追記してから実装**（[UX.md](./product/UX.md#スマホ対応のスコープv1-前対話で確定)）
