...
**P2 編成スクショ** — v13 Zen Kaku 目視（[screenshot-share-hero.html](./product/mockups/screenshot-share-hero.html)）
...
- [~] **編成スクショ機能**（要件すり合わせ中・2026-08-02）  
  ...
  - 次: **v13 目視**（金1行併記・Zen Kaku）→ [mockups/screenshot-share-hero.html](./product/mockups/screenshot-share-hero.html)（採用 / 方向違い / 惜しい＋一言）  
