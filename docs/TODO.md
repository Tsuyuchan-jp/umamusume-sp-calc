...
- [x] 2026-08-02 **背景を横長同梱に切替**（`assets/ui/uma-world.png`）・**レイアウト幅を gallery/split で統一**（1480px）
- [x] 2026-08-02 **ヘッダーをモック構造へ修正** — 浮いた別帯をやめ、編成パネル先頭の g-brand に
- [x] 2026-08-02 幾何タイル・スプリット左ゾーン・ヘッダー比較モック・指摘 backlog
