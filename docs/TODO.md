...
**デュアルUI移植中** — 第1弾＋マグネット削除／スプリット操作不能修正。残り: A要約化・継承上展開・H5トーン。表示崩れの詳細報告は第2弾後で可。
...
- [~] **デュアルUIを app へ移植**（第1弾済）— ギャラリー/スプリット切替・Bモーダル・C横並び。残り: A要約＋詳細／継承バー上展開／H5トーン
...
- [x] 2026-08-02 H5モック改訂（A/B/C・自動計上モーダル・C足元帯）
