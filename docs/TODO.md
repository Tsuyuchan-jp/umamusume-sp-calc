...
- [x] 2026-08-02 **主要面の隙間を統一** — `--layout-stack` / `--layout-gutter`（gallery・split・auto）
- [x] 2026-08-02 **レイアウトをモック型に** — クロム幅 1480 固定、本文は gallery 1180／split 1480
- [x] 2026-08-02 **背景を横長同梱に切替**・ヘッダーをパネル内 g-brand へ
- [x] 2026-08-02 幾何タイル・スプリット左ゾーン・指摘 backlog
