...
**カードピッカー刷新** — 結果作業台 W-H 実装済み。次は P-A＋薄い P-B
...
- [x] 2026-08-02 **編成枠DOMリファクタ** — 紫クロム（`.app-header`）＋白本体（`.deck-body`）。結果枠と同型
- [x] 2026-08-02 **結果枠DOMリファクタ** — 紫クロム（`.wb-regu`）＋白本体（`.workbench-body`）。負マージン食い込み廃止
- [x] 2026-08-02 **結果作業台 W-H 実装** — ON文言統一・レギュ即適用（手動OFF保持）・4列表・レギュ儀式バー
...
- [x] 2026-08-02 **背景横長同梱**・ヘッダー H-Mock・幾何・左ゾーン（初期指摘 #1/#3/#5/#6）
