...
- 再生成: `npm run extract:events` → `npm run apply:events`（手順: [GAME_UPDATE_RUNBOOK.md](./GAME_UPDATE_RUNBOOK.md)、設計経緯: [archive/EVENT_EXTRACT_DESIGN.md](./archive/EVENT_EXTRACT_DESIGN.md)）
